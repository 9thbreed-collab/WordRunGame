...
- [x] 01-02-PLAN.md -- PlatformServices autoload, banner ad region, and test screen
- [~] 01-03-PLAN.md -- Export pipeline validation (DEFERRED: Task 1 complete, Task 2 device testing blocked by hardware -- MacBook Air Mid-2013 cannot run Xcode 14+ for iPhone 14)
- [~] 01-04-PLAN.md -- Monetization plugin spike (Tasks 1-2 COMPLETE: AdMob v5.3 + godot-iap v1.2.3 installed and wired into PlatformServices; Task 3 device validation DEFERRED -- same hardware blocker as 01-03)
